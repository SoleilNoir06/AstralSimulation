...
namespace astral_simulation
{
    public static class Physics
    {
        ...
        private const float SUN_RADIUS = 0.046f;
        ...
        /// </summary>
        /// <param name="planetRadius">Planet's radius</param>
        ...
        {
            float gPull = G * M * planetMass / ((float)Math.Pow(ComputeDistanceBetweenSunAndPlanet(planetPosition), 2)); //Formula of law of universal gravitation
        ...
        {
            float velocity = (float)Math.Sqrt(G * M * (2f / MathF.Abs(ComputeDistanceBetweenSunAndPlanet(planetPosition) - 1f / planetSemiMajorAxis))); //Equation of computing of orbital velocity
