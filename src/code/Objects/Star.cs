namespace Astral_simulation
{
    ...
    public class Star : AstralObject
    {
        ...
        public Star(float temperature, float brightness, float luminosity, long mass, long radius, float orbitPeriod, float rotationPeriod): base (mass, radius, orbitPeriod, rotationPeriod)
        { 
